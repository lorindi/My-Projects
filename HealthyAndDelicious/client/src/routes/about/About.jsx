      ...
      <div className="contentAboutUs">
        <div className="aboutUsSection">
          ...
          <p className="aboutUsSectionDescription aboutUsSectionDescriptionFirst">
            Welcome to Healthy Delicious - your ultimate destination for
            nutritious and mouthwatering recipes. Founded by Lora Mitova, a
            passionate chef and nutrition enthusiast, our mission is to inspire
