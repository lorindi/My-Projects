...
//         className="flex items-center justify-evenly flex-col bg-neutral-50 rounded-[5px] w-full min-h-[673px]
//           web:w-[582px] web:h-[776px] 
//           tablet:w-[582px] tablet:h-[776px] 
//           phone:w-[361px] phone:min-h-[713px] "
//       >
...
//         >
//           <div
//             className="border border-zinc-400 web:w-[183px] web:h-[1px] 
      ...
      >
        ...
        <div className="justify-center items-center gap-2 inline-flex 
          ...
          <div className="border border-zinc-400 web:w-[183px] web:h-[1px] 
              tablet:w-[183px] tablet:h-[1px] phone:w-[145px] phone:h-[1px] smallPhone:w-[126px] smallPhone:h-[1px]"></div>
