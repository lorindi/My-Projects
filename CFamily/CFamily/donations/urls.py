...
from CFamily.donations.views import DonationCreateView, DonationEditView, DonationDeleteView, DonationDetailsView, \
    DonationListView, DonationMedicationsListView, DonationMedicalEquipmentListView, DonationSupportForResearchListView, \
    DonationPsychologicalSupportListView, DonationAnotherTypeListView, DonationMoneyCreateView
...
urlpatterns = [
    ...
    path('money/', DonationMoneyCreateView.as_view(), name='donation_money_create'),
