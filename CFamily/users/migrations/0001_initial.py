    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type_user', models.CharField(blank=True, choices=[('Parent of a patient', 'Parent of a patient'), ('Patient', 'Patient'), ('Donor', 'Donor'), ('Other', 'Other')], max_length=25, null=True, verbose_name='Type user')),
